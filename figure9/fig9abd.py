...
def field(t,a,x_hist,W,H):
	...
	field_u=(1/tau)*(mystim.stim(t)+amp_noise*is_noise*noise*np.sqrt(tau/dt)+conn_matrix.dot(phi(x_hist[-1],theta,uc))-x_hist[-1]-w_inh*np.dot(r1_matrix,phi(x_hist[-1],theta,uc)))#-a
